...
# Step 1: Load dataset
# -----------------------------
df = pd.read_csv("airfoil_latent_params.csv")  # columns: filename, p1..p6
...
# -----------------------------
# Step 2: Normalize inputs (train or load)
# -----------------------------
...
if not os.path.exists(model_path):
    ...
    params_scaled = scaler.fit_transform(params6)
    ...
    decoder = Model(inp, out, name="decoder_6x100x1000x80")
...
# -----------------------------
# Step 3: Predict and plot every 100th airfoil
# -----------------------------
x_pred = np.linspace(0, 1, 40)
indices = np.arange(0, len(params6), 100)  # every 100th airfoil

# indices = random.randint(0, len(params6))
